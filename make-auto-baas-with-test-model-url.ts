import * as giacCore from "https://denopkg.com/gov-suite/governed-iac@v1.1.15/core/mod.ts";
import * as autoBaaS from "https://denopkg.com/gov-suite/governed-iac@v1.1.15/models/omnibus/middleware-rdbms-api-auto-baas.services.giac.ts";
import * as pgsc from "https://denopkg.com/gov-suite/governed-iac@v1.1.15/models/persistence/postgreSQL-engine.service.giac.ts";
import * as govnImTrSqlDia from "https://denopkg.com/gov-suite/governed-im-transform@v0.9.12/rds/sql/dialect/mod.ts";
import * as govnImTrSQL from "https://denopkg.com/gov-suite/governed-im-transform@v0.9.12/rds/sql/mod.ts";
import type * as govnImCore from "https://denopkg.com/gov-suite/governed-im@v0.7.4/core/mod.ts";
import type * as artfPersist from "https://denopkg.com/shah/artifacts-persistence@v1.2.0/mod.ts";
...
import * as model from "https://denopkg.com/gov-suite/governed-im-rds@v0.10.13/models/test-model.gim.ts";
