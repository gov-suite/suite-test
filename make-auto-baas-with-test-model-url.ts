import * as giacCore from "https://denopkg.com/gov-suite/governed-iac@v1.1.2/core/mod.ts";
import * as autoBaaS from "https://denopkg.com/gov-suite/governed-iac@v1.1.2/models/omnibus/middleware-rdbms-api-auto-baas.services.giac.ts";
import * as pgsc from "https://denopkg.com/gov-suite/governed-iac@v1.1.2/models/persistence/postgreSQL-engine.service.giac.ts";
import * as govnImTrSqlDia from "https://denopkg.com/gov-suite/governed-im-transform@v0.9.7/rds/sql/dialect/mod.ts";
import * as govnImTrSQL from "https://denopkg.com/gov-suite/governed-im-transform@v0.9.7/rds/sql/mod.ts";
import type * as govnImCore from "https://denopkg.com/gov-suite/governed-im@v0.7.1/core/mod.ts";
...
import * as model from "https://denopkg.com/gov-suite/governed-im-rds@v0.10.9/models/test-model.gim.ts";
